...
let UserResolver = class UserResolver {
    ...
    login(options, { manager, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield manager.findOne(User_1.User, { where: { username: options.username } });
            if (!user) {
                return {
                    errors: [{
                            field: "username",
    ...
    me({ manager, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield manager.findOne(User_1.User, { where: { id: req.session.userId } });
            return user;
        });
    }
};
